...
import GitHubCard from '../generic/githubcard'
    ...
    return <div className="flex flex-col sm:flex-row">
        <div className="sm:w-3/5 sm:pr-8">
            <div className="flex flex-col">
                ...
                <h1 className="absolute filter blur-3xl opacity-60 font-black text-8xl text-transparent bg-clip-text bg-gradient-to-br from-red-400 to-yellow-200">Norminal</h1>
        ...
        <div className="self-center sm:w-2/5 pt-8">
